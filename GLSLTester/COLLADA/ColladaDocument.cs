    ...
    public class Document
    {
        ...
        public class Source : Element, ISourceOrVertices
        {
                ...
                : base(doc, node)
            {
                ...
                if (id == null) throw new Exception("Source[" + id + "] does not have id ! : " + doc.filename);
                // Read a source
        ...
        public class Vertices : Element, ISourceOrVertices
        {
                ...
                : base(doc, node)
            {
                ...
                if (id == null) throw new Exception("Vertices[" + id + "] does not have id ! : " + doc.filename);
        ...
        public class Locator
        {
            ...
            public Locator(Document doc, XmlNode node)
            {
                ...
                else if (node.Name == "input" || node.Name == "accessor" || node.Name == "skin" || node.Name == "morph")
                {
        ...
        public class Effect : Element
        {
            ...
            public Effect(Document doc, XmlNode node)
                : base(doc, node)
            {
                if (id == null) throw new Exception("Effect[" + id + "] does not have id ! : " + doc.filename);
        ...
        public class Material : Element
        {
            ...
            public Material(Document doc, XmlNode node)
                : base(doc, node)
            {
                if (id == null) throw new Exception("Material[" + id + "] does not have id ! : " + doc.filename);
        ...
        public class Controller : Element
        {
            ...
            public Controller(Document doc, XmlNode node)
                : base(doc, node)
            {
                if (id == null) throw new Exception("Controller[" + id + "] does not have id ! : " + doc.filename);
        ...
        public class Geometry : Element
        {
                ...
                : base(doc, node)
            {
                ...
                if (id == null) throw new Exception("Geometry[" + id + "] does not have id ! : " + doc.filename);
        ...
        public class Image : Element
        {
            ...
            public Image(Document doc, XmlNode node)
                : base(doc, node)
            {
                if (id == null) throw new Exception("Image[" + id + "] does not have id ! : " + doc.filename);
